...
class SessionManager:
    ...
    def create_session(self, user_id: int, token: str, ip_address: str, user_agent: str) -> str:
    ...
    def cleanup_expired_sessions(self):
        ...
        cutoff_time = datetime.utcnow() - timedelta(hours=24)  # Remove sessions older than 24 hours
